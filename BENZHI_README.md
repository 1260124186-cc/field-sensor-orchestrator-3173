# field-sensor-orchestrator__005 Docker 交付说明
...
```bash
./build_benzhi_docker.sh field-sensor-orchestrator__005-benzhi linux/amd64
docker run --rm -it field-sensor-orchestrator__005-benzhi bash
```
