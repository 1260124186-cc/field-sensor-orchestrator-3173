# field-sensor-orchestrator__002 Docker 交付说明
...
```bash
./build_benzhi_docker.sh field-sensor-orchestrator__002-benzhi linux/amd64
docker run --rm -it field-sensor-orchestrator__002-benzhi bash
```
