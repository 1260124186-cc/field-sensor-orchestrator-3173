# field-sensor-orchestrator__004 Docker 交付说明
...
```bash
./build_benzhi_docker.sh field-sensor-orchestrator__004-benzhi linux/amd64
docker run --rm -it field-sensor-orchestrator__004-benzhi bash
```
